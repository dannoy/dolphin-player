#BASE PATH FOR JNI
#AVPLAYER_PATH := "c:/p"
AVPLAYER_PATH := "/Users/apple/Downloads/dolphin_player/dolphin-player/pN"
AVPLAYER_PATH_BASE := "/Users/apple/Downloads/dolphin_player/dolphin-player/p"

# The namespace in Java file, with dots replaced with underscores
SDL_JAVA_PACKAGE_PATH := com_broov_playerN

# Path to shared libraries - Android 1.6 cannot load them properly, thus we have to specify absolute path here
SDL_SHARED_LIBRARIES_PATH := /data/data/com.broov.playerN/lib

# Your application will just set current directory there
SDL_CURDIR_PATH := /data/data/com.broov.playerN/files
