...
static void ANDROID_DeleteDevice(SDL_VideoDevice *device)
{
    ...
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside ANDROID_DeleteDevice");
#endif
	SDL_free(device);
}
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside ANDROID_CreateDevice");
#endif
...
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside ANDROID_Available");
#endif
	return 1;
}
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside ANDROID_VideoInit");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside ANDROID_GetDisplayModes");
#endif
	mode.w = SDL_ANDROID_sWindowWidth;
	mode.h = SDL_ANDROID_sWindowHeight;
	mode.refresh_rate = 0;
...
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside ANDROID_GetDisplayBounds");
#endif
...
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside ANDROID_SetDisplayMode");
#endif
	return 1;
};
...
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside ANDROID_VideoQuit");
#endif
}
...
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside ANDROID_GL_SwapBuffers");
#endif
...
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside ANDROID_GL_CreateContext");
#endif
...
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside ANDROID_GL_MakeCurrent");
#endif
	return 1;
};
...
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside ANDROID_GL_DeleteContext");
#endif
};
...
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside ANDROID_CreateWindow");
#endif
...
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside ANDROID_DestroyWindow");
#endif
