...
GLES_LoadFunctions(GLES_RenderData * data)
{
    ...
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_LoadFunctions");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_CreateRenderer");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_ActivateRenderer");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_DisplayModeChanged");
#endif
...
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_CreateTexture");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_QueryTexturePixels");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_SetTextureBlendMode");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_SetTextureScaleMode");
#endif
...
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_UpdateTexture");
#endif
    ...
    if( rect->w * bpp == pitch ) {
         //__android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_UpdateTexture Whole Texture");
         temp_buffer = (void *)pixels; /* No need to reformat */
    } else {
         //__android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_UpdateTexture Partial Texture: bpp: %d pitch:%d", bpp, pitch);
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_LockTexture");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_DirtyTexture");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_SetBlendMode");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_RenderDrawPoints");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_RenderDrawLines");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_RenderDrawRects");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_RenderFillRects");
#endif
                ...
                const SDL_Rect * srcrect, const SDL_Rect * dstrect)
{
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_RenderCopy");
#endif
    ...
    if (texturedata->dirty.list) {
        ...
        for (dirty = texturedata->dirty.list; dirty; dirty = dirty->next) {
            ...
            if( rect->x == 0 && rect->w * bpp == pitch ) {
                //__android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_RenderCopy Update Whole Texture");
                temp_buffer = pixels; /* Updating whole texture, no need to reformat */
            } else {
                __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_RenderCopy Update Partial Texture: bpp: %d pitch:%d", bpp, pitch);
                temp_buffer = SDL_malloc(rect->w * rect->h * bpp);
                temp_ptr = temp_buffer;
                for (i = 0; i < rect->h; i++) {
                    SDL_memcpy(temp_ptr, pixels, rect->w * bpp);
    ...
    case SDL_TEXTURESCALEMODE_NONE:
    case SDL_TEXTURESCALEMODE_FAST:
        //__android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_RenderCopy SDL_TextureScaleMode_Fast");
    ...
    case SDL_TEXTURESCALEMODE_SLOW:
    case SDL_TEXTURESCALEMODE_BEST:
        //__android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_RenderCopy SDL_TextureScaleMode_Slow");
        data->glTexParameteri(texturedata->type, GL_TEXTURE_MIN_FILTER,
                              GL_LINEAR);
        data->glTexParameteri(texturedata->type, GL_TEXTURE_MAG_FILTER,
                              GL_LINEAR);
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_RenderPresent");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_DestroyTexture");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside GLES_DestroyRenderer");
#endif
