...
SDL_VideoInit(const char *driver_name, Uint32 flags)
{
    ...
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_VideoInit");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_CreateTexture");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_CreateTextureFromSurface");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_LockTexture");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_RenderDrawRects");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_RenderFillRects");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_RenderCopy");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_RenderReadPixels");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_RenderWritePixels");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_RenderPresent");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_DestroyTexture");
#endif
    CHECK_TEXTURE_MAGIC(texture, );
    texture->magic = NULL;
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_DestroyRenderer");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_VideoQuit");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_GL_LoadLibrary");
#endif
    if (!_this) {
        SDL_UninitializedVideo();
        return -1;
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_GL_GetProcAddress");
#endif
    void *func;
...
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_GL_UnloadLibrary");
#endif
    if (!_this) {
        SDL_UninitializedVideo();
        return;
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_GL_ExtensionSupported");
#endif
...
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_GL_SetAttribute");
#endif
#if SDL_VIDEO_OPENGL || SDL_VIDEO_OPENGL_ES
    int retval;
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_GL_GetAttribute");
#endif
...
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_GL_CreateContext");
#endif
    CHECK_WINDOW_MAGIC(window, NULL);
...
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_GL_MakeCurrent");
#endif
    CHECK_WINDOW_MAGIC(window, -1);
...
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_GL_SetSwapInterval");
#endif
    if (!_this) {
        SDL_UninitializedVideo();
        return -1;
...
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_GL_GetSwapInterval");
#endif
...
{
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_GL_SwapWindow");
#endif
    CHECK_WINDOW_MAGIC(window, );
