...
./configure --target-os=linux \
    ...
    --sysroot=$PLATFORM \
    --extra-cflags=" -O3 -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 $OPTIMIZE_CFLAGS -I$BZLIBPATH -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE" \
    --enable-gpl \
    --enable-version3 \
    --disable-shared \
    --enable-static \
