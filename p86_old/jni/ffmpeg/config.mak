...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --prefix=./android/armv6_vfp --enable-cross-compile --extra-libs=-lgcc --arch=arm --cc=/Users/pinxue/android/android-ndk-r4/build/prebuilt/darwin-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc --cross-prefix=/Users/pinxue/android/android-ndk-r4/build/prebuilt/darwin-x86/arm-eabi-4.4.0/bin/arm-eabi- --nm=/Users/pinxue/android/android-ndk-r4/build/prebuilt/darwin-x86/arm-eabi-4.4.0/bin/arm-eabi-nm --sysroot=/Users/pinxue/android/android-ndk-r4/build/platforms/android-8/arch-arm/ --extra-cflags=' -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums  -fno-strict-aliasing -finline-limit=300 -DCMP_HAVE_VFP -mfloat-abi=softfp -mfpu=vfp -marm -march=armv6 ' --disable-shared --enable-static --extra-ldflags='-Wl,-rpath-link=/Users/pinxue/android/android-ndk-r4/build/platforms/android-8/arch-arm//usr/lib -L/Users/pinxue/android/android-ndk-r4/build/platforms/android-8/arch-arm//usr/lib  -nostdlib -lc -lm -ldl -llog' --enable-parsers --disable-encoders --enable-decoders --disable-muxers --enable-demuxers --enable-swscale --disable-ffplay --disable-ffprobe --disable-ffserver --enable-network --enable-indevs --disable-bsfs --disable-filters --enable-protocols --enable-asm
prefix=./android/armv6_vfp
...
SRC_PATH="/Users/pinxue/projects/rockplayer/hg/work/RockPlayer/android/app/jni/ffmpeg/ffmpeg-git-master"
SRC_PATH_BARE=/Users/pinxue/projects/rockplayer/hg/work/RockPlayer/android/app/jni/ffmpeg/ffmpeg-git-master
BUILD_ROOT="/Users/pinxue/projects/rockplayer/hg/work/RockPlayer/android/app/jni/ffmpeg/ffmpeg-git-master"
CC_IDENT=gcc 4.4.0 (GCC)
ARCH=arm
CC=/Users/pinxue/android/android-ndk-r4/build/prebuilt/darwin-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
AS=/Users/pinxue/android/android-ndk-r4/build/prebuilt/darwin-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
LD=/Users/pinxue/android/android-ndk-r4/build/prebuilt/darwin-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
DEPCC=/Users/pinxue/android/android-ndk-r4/build/prebuilt/darwin-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
YASM=yasm
YASMDEP=yasm
AR=/Users/pinxue/android/android-ndk-r4/build/prebuilt/darwin-x86/arm-eabi-4.4.0/bin/arm-eabi-ar
RANLIB=/Users/pinxue/android/android-ndk-r4/build/prebuilt/darwin-x86/arm-eabi-4.4.0/bin/arm-eabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=/Users/pinxue/android/android-ndk-r4/build/prebuilt/darwin-x86/arm-eabi-4.4.0/bin/arm-eabi-strip
CPPFLAGS= --sysroot=/Users/pinxue/android/android-ndk-r4/build/platforms/android-8/arch-arm/ -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS= -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -DCMP_HAVE_VFP -mfloat-abi=softfp -mfpu=vfp -marm -march=armv6  -std=c99 -fomit-frame-pointer -fPIC -marm -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
ASFLAGS= -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -DCMP_HAVE_VFP -mfloat-abi=softfp -mfpu=vfp -marm -march=armv6  -fPIC -g
CC_O=-o $@
LDFLAGS= -Wl,-rpath-link=/Users/pinxue/android/android-ndk-r4/build/platforms/android-8/arch-arm//usr/lib -L/Users/pinxue/android/android-ndk-r4/build/platforms/android-8/arch-arm//usr/lib -nostdlib -lc -lm -ldl -llog --sysroot=/Users/pinxue/android/android-ndk-r4/build/platforms/android-8/arch-arm/ -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil
