...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_SetVideoMode");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_CreateYUVOverlay");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_LockYUVOverlay");
#endif
...
#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_UnlockYUVOverlay");
#endif
...
int
SDL_DisplayYUVOverlayRenderCopy(SDL_Overlay * overlay, SDL_Rect * dstrect)
{

#ifndef BROOV_PLAYER_NO_DEBUG_LOG
    __android_log_print(ANDROID_LOG_INFO, "SDLLOG", "Inside SDL_DisplayYUVOVerlayRenderCopy");
#endif
