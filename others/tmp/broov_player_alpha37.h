...
typedef struct VideoState 
{
  ...
  VPacketQueue     video2q;
#endif
  SDL_Thread      *video2_tid;
  VideoQueue	   frameq[VIDEO_FRAME_QUEUE_SIZE];
  int      	   frameq_size, frameq_rindex, frameq_windex;
  SDL_mutex       *frameq_mutex;
  SDL_cond        *frameq_cond;
